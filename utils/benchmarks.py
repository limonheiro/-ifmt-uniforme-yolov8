...
def benchmark(model=Path(SETTINGS['weights_dir']) / 'yolov8n.pt',
              ...
              device='cpu',
              hard_fail=False,
              url="https://raw.githubusercontent.com/limonheiro/ifmt-uniforme-yolov5/main/get_data/facebook_download_album/fotos/261534189_4693332230710102_777142350071569229_n.jpg"):
    """
    ...
    for i, (name, format, suffix, cpu, gpu) in export_formats().iterrows():  # index, (name, format, suffix, CPU, GPU)
        ...
        try:
            ...
            if not (ROOT / 'assets/261534189_4693332230710102_777142350071569229_n.jpg').exists():
                download(url=url, dir=ROOT / 'assets')
            export.predict(ROOT / 'assets/261534189_4693332230710102_777142350071569229_n.jpg', imgsz=imgsz, device=device, half=half)
